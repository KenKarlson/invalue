...
function App() {
  ...
  const handleAddToList = () => {
    if (currentValue.trim().length >= 3) {
      ...
      setCurrentValue(""); // Очищаем текущее значение после добавления
    }
  };
  ...
  // Проверка валидности значения (минимум 3 символа)
  ...
  return React.createElement(
    ...
    [
      ...
      // Блок ошибки (показывается только если значение некорректно)
